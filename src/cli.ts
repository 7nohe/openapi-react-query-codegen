...
async function setupProgram() {
  ...
  program
    ...
    .option("--exportCore <value>", "Export core - Generate Core client classes?")
    ...
    .addOption(new Option('--indent <value>', 'Depreciated - now unused - left for backwards compatibility').hideHelp())
    // TODO: remove these options in the next major release
    .addOption(new Option('--useUnionTypes <value>', 'Depreciated - now unused - left for backwards compatibility').hideHelp())
    .parse();
